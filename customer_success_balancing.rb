...
class CustomerSuccessBalancing
  ...
  def execute
    sorted_customer_success = customer_success_by_customers_count(customer_success_with_customers_count)
  ...
  def customer_success_by_customers_count(customer_success_with_customers_count)
